...
int plotSpinDensity_v3(const char *fin_name, uint ind) {
  ...
  TFile fin(fin_name);
  TList *ll = ((TCanvas*)fin.Get(TString::Format("page0")))->GetListOfPrimitives();  // dirty hack //, ind
