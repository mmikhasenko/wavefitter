...
namespace MAscoli {
  ...
  double getReducedDeck(double costheta, double phi,
  ...
  double getProjectedReducedDeck(uint J, int M, uint L,
  ...
  double upperPart(double costheta,
                            double mS1sq, uint S1, int lamS1, double RS1,
                            double wsq, double t,
                            double mtRsq,
                            double mAsq,
  ...
  double sPionProton(double costheta, double phi,
                            double mS1sq,
                            double wsq, double t,
                            double stot,
                            double mAsq, double mBsq, double mDsq,
