...
//region of fit
#define LEFT_INT1   1.4
#define RIGHT_INT1  2.4
#define LEFT_INT2   1.4
...
int main(int ac, char** av) {  
  ...
  for(int e=0;e<nAttempt;e++) {
    ...
    TF1 fInt1_fr(fInt1); fInt1_fr.SetRange(F2_MASS+PI_MASS,gh1->GetBinLowEdge(gh1->GetNbinsX())+gh1->GetBinWidth(1)); fInt1_fr.SetLineColor(kOrange);
    TF1 fInt2_fr(fInt2); fInt2_fr.SetRange(F2_MASS+PI_MASS,gh1->GetBinLowEdge(gh1->GetNbinsX())+gh1->GetBinWidth(1)); fInt2_fr.SetLineColor(kOrange);
    TF1  fPhi_fr(fPhi);   fPhi_fr.SetRange(F2_MASS+PI_MASS,gh1->GetBinLowEdge(gh1->GetNbinsX())+gh1->GetBinWidth(1));  fPhi_fr.SetLineColor(kOrange);
