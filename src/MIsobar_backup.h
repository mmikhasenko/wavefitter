...
class MIsobar{
 ...
 private:
  ...
  double rdph1 (double *x, double *par) const;
  double idph1 (double *x, double *par) const;
  double rdph2 (double *x, double *par) const;
  double idph2 (double *x, double *par) const;
